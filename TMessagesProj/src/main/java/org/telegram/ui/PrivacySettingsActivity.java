            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == deleteAccountDetailRow) {
                        ...
                        privacyCell.setText(LocaleController.formatString("PrivacyPaymentsClearInfo", R.string.PrivacyPaymentsClearInfo, ApplicationLoader.getConfig().getAppName()));
                        ...
                        privacyCell.setText(LocaleController.formatString("PrivacyCallsP2PHelp", R.string.PrivacyCallsP2PHelp, ApplicationLoader.getConfig().getAppName()));
