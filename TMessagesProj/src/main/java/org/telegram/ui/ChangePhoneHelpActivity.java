...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        try {
            textView1.setText(AndroidUtilities.replaceTags(LocaleController.formatString("PhoneNumberHelp", R.string.PhoneNumberHelp, ApplicationLoader.getConfig().getAppName())));
        } catch (Exception e) {
            FileLog.e(e);
            textView1.setText(LocaleController.formatString("PhoneNumberHelp", R.string.PhoneNumberHelp, ApplicationLoader.getConfig().getAppName()));
        }
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage(LocaleController.formatString("PhoneNumberAlert", R.string.PhoneNumberAlert, ApplicationLoader.getConfig().getAppName()));
