            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == messageAlertRow) {
                        ...
                        checkCell.setTextAndCheck(LocaleController.formatString("ContactJoined", R.string.ContactJoined, ApplicationLoader.getConfig().getAppName()), preferences.getBoolean("EnableContactJoined", true), true);
                    } else if (position == pinnedMessageRow) {
                        ...
                        checkCell.setTextAndValueAndCheck(LocaleController.getString("NotificationsServiceConnection", R.string.NotificationsServiceConnection), LocaleController.formatString("NotificationsServiceConnectionInfo", R.string.NotificationsServiceConnectionInfo, ApplicationLoader.getConfig().getAppName()), preferences.getBoolean("pushConnection", true), true, true);
                    } else if (position == badgeNumberRow) {
