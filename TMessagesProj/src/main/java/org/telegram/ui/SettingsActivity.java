        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    Spannable spanned = new SpannableString(Html.fromHtml(LocaleController.formatString("AskAQuestionInfo", R.string.AskAQuestionInfo,
                            ApplicationLoader.getConfig().getAppName(), ApplicationLoader.getConfig().getFaqUrl()).replace("\n", "<br>")));
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.formatString("TelegramFAQ", R.string.TelegramFaq, ApplicationLoader.getConfig().getAppName()), true);
                    } else if (position == contactsReimportRow) {
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("TelegramVersion", R.string.TelegramVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi),ApplicationLoader.getConfig().getAppName()));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
