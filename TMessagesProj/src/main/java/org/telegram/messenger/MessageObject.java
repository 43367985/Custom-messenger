        ...
        if (message instanceof TLRPC.TL_messageService) {
            if (message.action != null) {
                if (message.action instanceof TLRPC.TL_messageActionCustomAction) {
                    ...
                    messageText = LocaleController.formatString("NotificationContactJoined", R.string.NotificationContactJoined, UserObject.getUserName(fromUser), ApplicationLoader.getConfig().getAppName());
            ...
            if (message.media instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                messageText = LocaleController.getAppNameString("UnsupportedMedia", R.string.UnsupportedMedia);
