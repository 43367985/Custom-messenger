        ...
        notificationsQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String name = ApplicationLoader.getConfig().getAppName();
                ...
                if (preferences.getBoolean("EnablePreviewAll", true)) {
                    if (messageObject.messageOwner instanceof TLRPC.TL_messageService) {
                        if (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionUserJoined) {
                            msg = LocaleController.formatString("NotificationContactJoined", R.string.NotificationContactJoined, name, ApplicationLoader.getConfig().getAppName());
    ...
    private void showExtraNotifications(NotificationCompat.Builder notificationBuilder, boolean notifyAboutLast) {
        ...
        for (int b = 0; b < sortedDialogs.size(); b++) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(ApplicationLoader.applicationContext)
                    ...
                    .setColor(ApplicationLoader.getConfig().getDefaultTheme().getActionBarColor())
